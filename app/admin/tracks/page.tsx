  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-[#1E3A5F]">Influence Labs</h2>
        <Link
          href="/admin/tracks/new"
          className="bg-[#1E3A5F] text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-[#162d4a]"
        >
          Create Influence Lab
        </Link>
      </div>

      {tracks.length === 0 ? (
        <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
          <p className="text-gray-500 mb-4">No Influence Labs yet.</p>
          <Link
            href="/admin/tracks/new"
            className="bg-[#1E3A5F] text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-[#162d4a]"
          >
            Create your first Influence Lab
          </Link>
        </div>
      ) : (
        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
          ...
          <table className="w-full min-w-[640px]">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="text-left px-6 py-3 text-xs font-medium text-gray-500 uppercase">Influence Lab</th>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <DeleteButton
                        ...
                        confirmMessage={`Delete Influence Lab "${track.trackName}"? This will permanently delete all lessons, scenarios, questions, and belts for this Influence Lab.`}
