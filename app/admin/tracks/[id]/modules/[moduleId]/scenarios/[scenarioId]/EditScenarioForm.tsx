...
export default function EditScenarioForm({
  ...
  // Pad responses to always show 4 slots
  const [responses, setResponses] = useState<ResponseField[]>(() => {
    const padded = [...initial.responses]
    while (padded.length < 4) padded.push(emptyResponse())
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <p className="text-xs text-gray-500 mb-4">
            Blank responses will be removed on save.
          </p>
